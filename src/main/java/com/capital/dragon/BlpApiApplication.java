...
public class BlpApiApplication {
	private static final Logger logger = LoggerFactory.getLogger(BlpApiApplication.class);
	...
	public static void main(String[] args) {
		...
		if (applicationContext != null && mode != null && "stop".equals(mode)) {
			...
			SpringApplication app = new SpringApplication(BlpApiApplication.class);
